...
"""
import sys
sys.path.append('/home/harsimar/harsimardata/fastmriold/FastMRI-Challenge/fastMRI/')
import logging
import pathlib
import random
import shutil
...
from models.unet.unetpp import NestedUNet
from models.unet.EfficientNet_PyTorch.efficientnet_pytorch.model import *
...
def train_epoch(args, epoch, model, data_loader, optimizer, writer):
    ...
    for iter, data in enumerate(data_loader):
        ...
        #print(output.shape)
        #output = output.view(output.size(0),320,320)
        #print(output.shape)
